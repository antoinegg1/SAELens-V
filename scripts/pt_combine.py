...
# 示例用法
folder_path = "/mnt/file2/changye/dataset/Align-Anything-preference_interp/l0"  # 替换为你的文件夹路径
output_file = "/mnt/file2/changye/dataset/Align-Anything-preference_interp/Align-Anything-preference_l0.pt"  # 替换为你的输出文件路径
